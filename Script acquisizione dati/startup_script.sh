...
if find /dev/ttyAMA0| grep -q .; then echo "DataLogger FOUND"; DATALOG=1; else echo "DataLogger NOT FOUND"; fi
 
if [[ $MM == 0 || $XLR8 == 0 || $DATALOG == 0 ]]
then 
...
if [ $XLR8 == 1 ]; then python /home/pi/Desktop/xlr8_read.py ; fi &
if [ $MM == 1 ]; then python /home/pi/Desktop/MM_sensor_read.py ; fi &
if [ $DATALOG == 1 ]; then sudo python /home/pi/Desktop/DataLogger_read.py ; fi &

echo "Press S to stop logging"
read STOP
if [[ $STOP == "S" ]]; then sudo killall -9 python; exit; fi